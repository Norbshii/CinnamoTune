...
if st.button('Generate Playlist'):
    with st.spinner('Fetching tracks and creating your playlist...'):
...
# Note on Spinner Usage:
# The st.spinner is used here to provide a visual indication that tracks are being fetched and the playlist is being created.
# This helps improve user experience by indicating that the process is underway, especially if it takes a few seconds to complete.
